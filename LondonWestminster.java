...
public class LondonWestminster extends AppCompatActivity
{
    private Context mContext = LondonWestminster.this;
    ...
    public String hotel = "London Westminster";
    public String room = "";
    ...
    private Integer[] hotelImages = {R.drawable.london_westminster_kitchen, R.drawable.london_westminster_lobby, R.drawable.london_westminster_room};
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_london_westminster);
    ...
    protected void dateChanger() //Allows the user to input their check in and check out dates.
    {
        ...
        dateSetListener_out = new DatePickerDialog.OnDateSetListener()
        {
            ...
            public void onDateSet(DatePicker datePicker, int year, int month, int day)
            {
                ...
                if(monthOut >= monthIn && dateOut < dateIn)
                {
                    ...
                    Animation animation = AnimationUtils.loadAnimation(LondonWestminster.this, R.anim.fadein);
        ...
        checkOut.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                DatePickerDialog dialog = new DatePickerDialog(LondonWestminster.this, android.R.style.Theme_Holo_Dialog_MinWidth, dateSetListener_out, inYear, inMonth, inDay);
        ...
        checkIn.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                DatePickerDialog dialog = new DatePickerDialog(LondonWestminster.this, android.R.style.Theme_Holo_Dialog_MinWidth, dateSetListener_in, year, month, day);
                dialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
                dialog.show();
            }
        });
    ...
    protected void confirmBooking()
    {
        ...
        bookButton.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                {
                    Intent ConfirmIntent = new Intent(LondonWestminster.this, ConfirmBookingPage.class);
    ...
    protected void slidingImages()
    {
        ...
        viewPagerAdapter = new ViewPagerAdapter(LondonWestminster.this, imagesArray);
    ...
    protected void roomAvailabilities(final String userRoom) //Check firebase Hotels child for hotel room availabilities depending on the hotel the user has clicked. Parameter input is user room that they chose.
    {
        ...
        Query key = reference.child("Hotels").child("London Westminster").child(userRoom);
    ...
    {
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference();
        Query key = reference.child("Prices").child("London Westminster");
        key.addListenerForSingleValueEvent(new ValueEventListener()
        {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot)
